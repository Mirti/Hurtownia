...
public class InCreate {
    ...
    private static void addTitlePage(Document document)
        ...
        preface.add(new Paragraph(
                "Raport wygenerowany przez: " + System.getProperty("user.name")
                + smallBold));
    ...
    private static void createTable(String date1, String date2) throws BadElementException, SQLException, DocumentException {
        ResultSet rs = Polaczenie.getData("SELECT * from produkt WHERE "
                + "data_waznosci BETWEEN '"+date1+"' AND '"+date2+"' ORDER BY data_waznosci DESC");
        ...
        while (rs.next()) {
            ...
            table.addCell(rs.getString("dostawca_importer_id"));
